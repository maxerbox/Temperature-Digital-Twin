...
# ── Configuration via dlt config resolution ──────────────────────────────────
# dlt checks (1) env vars, (2) secrets.toml, (3) config.toml — in that order.
# Custom values live under [sources.mqtt2hf] in .dlt/config.toml and .dlt/secrets.toml.
